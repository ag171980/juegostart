...
var game = (function () {
  ...
  function Player(life, score,image) {
      ...
      player.doAnything = function() {
          ...
          if(!(keyPressed.left && player.posX > 5)&&!(keyPressed.right && player.posX < (canvas.width - player.width - 5)))
              {
                   player.src='images/navefastc.png';
              }
      };
  ...
  function checkCollisions(shot) {
      ...
      if (shot.isHittingEvil()) {
          if (evil.life > 1) {
            ...
            evil.life--;
            setTimeout(() => preloadImages('images/enemie.png','images/navemala.png'),100)
  ...
  function showCongratulations () {
      ...
      bufferctx.font="bold 20px Arial";
      bufferctx.fillText("Felicidades el juego ha terminado!", canvas.width / 2 - 200, canvas.height / 2 - 30);
